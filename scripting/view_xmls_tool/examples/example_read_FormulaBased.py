...
print(type(testext))
xmltest._scan_knowledgerules(systemname = "ijsselmeergebied_doorzicht")
...
fb_tag = xmltest.get_element_formula_based(systemname = "ijsselmeergebied_doorzicht", fbname = "P_chara_visibility")
